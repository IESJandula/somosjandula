                            ...
                            <div class="form-row">
                                ...
                                <div class="color-selection">
                                    <select v-model="nuevaCategoria.color" class="form-select">
                                        ...
                                        <option v-for="color in coloresDisponibles" :key="color.value"
                                            :value="color.value">
                                            {{ color.nombre }}
                                        </option>
                                    </select>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-row">
                                ...
                                <select v-model="evento.nombre" class="form-select" required>
                                    ...
                                    <option v-for="categoria in categorias" :key="categoria.nombre"
                            ...
                            <div class="form-row combined-row">
                                <div class="checkbox-wrapper">
                                    <input type="checkbox" id="eventoMismoDia" v-model="eventoMismoDia"
                                        @change="toggleMismoDia" class="form-checkbox" />
                                ...
                                <div v-if="!eventoMismoDia" class="fecha-fin-wrapper">
                                    ...
                                    <input type="date" v-model="evento.fechaFin" class="form-input"
                ...
                <div class="form-container-table table-container">
                    ...
                    <div class="table-wrapper">
                        <table class="events-table">
                            ...
                            <tbody>
                                <tr v-for="eventoItem in eventos"
                                    :key="`${eventoItem.titulo}-${eventoItem.fechaInicio}`">
