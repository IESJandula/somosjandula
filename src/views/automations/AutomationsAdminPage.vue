...
//Prueba
const probarComandoEstadoProyector = async () => {
  try {
    const response = await obtenerComandoEstadoProyector(
      toastMessage,
      toastColor,
      isToastOpen,
      macPruebaProyector.value
    );

    comandoEstadoProyector.value = response?.comandoEstado ?? "";
