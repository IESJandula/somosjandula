...
export const imagesClonerApiUrl = import.meta.env.VITE_IMAGES_CLONER_API_BASE_URL as string
export const auditApiUrl = import.meta.env.VITE_AUDIT_API_BASE_URL as string